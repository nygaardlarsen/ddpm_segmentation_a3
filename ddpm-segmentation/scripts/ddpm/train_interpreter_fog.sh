...
EXPERIMENTS=(
    "/work/ddpm-segmentation/experiments/horse_21/ddpm_fog_severity1.json"
    "/work/ddpm-segmentation/experiments/horse_21/ddpm_fog_severity3.json"
    "/work/ddpm-segmentation/experiments/horse_21/ddpm_fog_severity5.json"
)
